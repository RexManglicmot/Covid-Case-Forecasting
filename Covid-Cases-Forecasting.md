...
-   <a href="#plot-theory" id="toc-plot-theory">Plot Theory</a>
...
-   **Figure our why Prophet does not work on GitHub but does on
    RStudio**
...
government lock downs, encouragement of practicing health hygiene
...
world has weathered the storm and moved on from this pandemic. Many news
stories have focused their topics on other issues, which implies that
the Covid pandemic is of no public concern.
...
This project will implement forecasting methods based on two models:
ARIMA and Prophet. By comparing and contrasting these two models, we can
determine if the forecasts project upward, downward, or parallel. Having
this provides public health officials ample time to plan health
initiatives (i.e. testing centers) and procure necessary medical in the
future (i.e., needles, gauzes, bandages). The time horizon for this
project is 3 years as I feel that it is not too near to the present time
nor too far.
...
and needs to be formatted to a Date class.
...
general, the lower the AIC and BIC values, the better the model. Both
AIC and BIC are used to score a model based on log-likelihood and
